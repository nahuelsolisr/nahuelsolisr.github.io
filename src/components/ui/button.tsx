...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    ...
    // Avoid attaching ripple/glow handlers when rendering asChild (e.g., wrapping a Next Link)
    // to prevent interfering with navigation or non-button elements.
    const eventHandlers = asChild
      ? {}
      : { onMouseMove: handleGlow, onClick: combinedClickHandler };
